 ...
 ***************************************************************************/
	...
	define('ONPHP_SOURCE_PATH', ONPHP_ROOT_PATH.'source'.DIRECTORY_SEPARATOR);
	// Default widgets templates is bootstrap
	define ('ONPHP_UI_DEFAULT_WTEMPLATES_PATH', ONPHP_SOURCE_PATH.'template'.DIRECTORY_SEPARATOR.'widget'.DIRECTORY_SEPARATOR.'bootstrap'.DIRECTORY_SEPARATOR);
	...
	set_include_path(
		...
		.ONPHP_MAIN_PATH.'UI'.DIRECTORY_SEPARATOR.'Filter'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'UI'.DIRECTORY_SEPARATOR.'Helper'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'UI'.DIRECTORY_SEPARATOR.'View'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'UI'.DIRECTORY_SEPARATOR.'Widgets'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'UI'.DIRECTORY_SEPARATOR.'Widgets'.DIRECTORY_SEPARATOR.'Base'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'UI'.DIRECTORY_SEPARATOR.'Widgets'.DIRECTORY_SEPARATOR.'Html'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'UI'.DIRECTORY_SEPARATOR.'Widgets'.DIRECTORY_SEPARATOR.'Utils'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'UI'.DIRECTORY_SEPARATOR.'Widgets'.DIRECTORY_SEPARATOR.'Making'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'UI'.DIRECTORY_SEPARATOR.'Widgets'.DIRECTORY_SEPARATOR.'Tables'.PATH_SEPARATOR
		.ONPHP_MAIN_PATH.'UI'.DIRECTORY_SEPARATOR.'Widgets'.DIRECTORY_SEPARATOR.'Forms'.PATH_SEPARATOR
		...
		.ONPHP_MAIN_PATH.'View'.PATH_SEPARATOR
